...
@Component(immediate = true, service = Servlet.class, property = {
        ...
        SLING_SERVLET_PATHS + "=" + "/bin/ClienteServlet",
        SLING_SERVLET_EXTENSIONS + "=" + "txt", SLING_SERVLET_EXTENSIONS + "=" + "json"})

@ServiceDescription("Servlet do Cliente")
public class ClienteServlet extends SlingAllMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest req,
        ...
        String json = clienteService.doGet(req,resp);
    ...
    protected void doPost(final SlingHttpServletRequest req,
                          final SlingHttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("application/json");
        String json = clienteService.doPost(req,resp);
        resp.getWriter().write(json);
    }
    @Override
    protected void doDelete(final SlingHttpServletRequest req,
                            final SlingHttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("application/json");
        String json = clienteService.doDelete(req,resp);
        resp.getWriter().write(json);
    }
    @Override
    protected void doPut(final SlingHttpServletRequest req,
                            final SlingHttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("application/json");
        String json = clienteService.doPut(req,resp);
        resp.getWriter().write(json);
